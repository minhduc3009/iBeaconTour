import '../s1_screen/widgets/listrectanglenineteen_item_widget.dart';
...
class S1Screen extends GetWidget<S1Controller> {
  @override
                                ...
                                Row(
                                    ...
                                    children: [
                                      CustomDropDown(
                                          ...
                                          items: controller.s1ModelObj.value
                                              .dropdownItemList,
                                          prefix: Container(
                                              margin: getMargin(
                                                  left: 15,
                                                                    ...
                                                                    Align(
                                                                        ...
                                                                        child: Padding(
                                                                            padding: getPadding(
                                                                                ...
                                                                                right: 16,
                                                                                bottom: 14),
                                                                            child: CommonImageView(svgPath: ImageConstant.imgSearch, height: getSize(18.00), width: getSize(18.00))))
                                                                  ])))),
                                                  Align(
                                                      alignment:
                                                              ...
                                                              itemBuilder:
                                                                ...
                                                                ListrectanglenineteenItemModel
                                                                    ...
                                                                    controller
                                                                        .s1ModelObj
                                                                        .value
                                                                        .listrectanglenineteenItemList[index];
                                                                    ...
                                                                    Container(
                                                                        ...
                                                                        child: Stack(
                                                                            alignment:
                                                                                Alignment.centerLeft,
                                                                            children: [
                                                                              Align(alignment: Alignment.bottomRight, child: Padding(padding: getPadding(left: 10, top: 10, bottom: 1), child: ClipRRect(borderRadius: BorderRadius.circular(getHorizontalSize(17.00)), child: CommonImageView(imagePath: ImageConstant.imgImage5, height: getVerticalSize(211.00), width: getHorizontalSize(129.00), fit: BoxFit.cover)))),
                                                                              Align(alignment: Alignment.centerLeft, child: ClipRRect(borderRadius: BorderRadius.circular(getHorizontalSize(10.00)), child: CommonImageView(imagePath: ImageConstant.imgImage5285X150, height: getVerticalSize(285.00), width: getHorizontalSize(150.00), fit: BoxFit.cover)))
                                                                            ]))),
                                                            Align(
                                                                alignment: Alignment
                                                                    .bottomLeft,
                                                                        ...
                                                                        children: [
                                                                          Container(
                                                                              ...
                                                                              child: Stack(alignment: Alignment.center, children: [
                                                                                Align(alignment: Alignment.centerLeft, child: Padding(padding: getPadding(left: 21, top: 41, right: 21, bottom: 41), child: ClipRRect(borderRadius: BorderRadius.circular(getHorizontalSize(17.00)), child: CommonImageView(imagePath: ImageConstant.imgImage7, height: getVerticalSize(192.00), width: getHorizontalSize(167.00), fit: BoxFit.cover)))),
                                                                                Align(
                                                                                    alignment: Alignment.center,
                                                                                    child: Container(
                                                                                        height: getVerticalSize(285.00),
                                                                          ...
                                                                          Container(
                                                                              margin: getMargin(left: 27, top: 198, bottom: 8),
                                                                              decoration: AppDecoration.gradientWhiteA70070WhiteA700.copyWith(borderRadius: BorderRadiusStyle.roundedBorder10),
                                                                              child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                                Padding(padding: getPadding(left: 11, top: 9, right: 11), child: Text("lbl_rest_pray".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtSenExtraBold16)),
                                                                                Padding(
